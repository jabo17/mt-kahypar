...
int main(int argc, char *argv[])
{
  ...
  mt_kahypar_set_partitioning_parameters(context, 8 /* number of blocks */,
  ...
  mt_kahypar_partitioned_hypergraph_t partitioned_hg =
      mt_kahypar_read_partition_from_file(hypergraph, QUALITY, 8 /* number of blocks */,
                                          "ibm01.hgr.part8");
  ...
  mt_kahypar_improve_partition(
      partitioned_hg, context,
