...
// Compile with: g++ -std=c++14 -DNDEBUG -O3 partition_with_individual_block_weights.cc -o
// example -lmtkahypar
int main(int argc, char *argv[])
{
  ...
  mt_kahypar_set_partitioning_parameters(
      context, 4 /* number of blocks */,
      0.03 /* imbalance parameter not relevant for partitioning with individual block
              weights */
      ,
  ...
  mt_kahypar_set_individual_target_block_weights(context, 4,
                                                 individual_block_weights.get());
  ...
  std::cout << "Weight of Block 0 = " << block_weights[0]
            << " (<= " << individual_block_weights[0] << ")" << std::endl;
  std::cout << "Weight of Block 1 = " << block_weights[1]
            << " (<= " << individual_block_weights[1] << ")" << std::endl;
  std::cout << "Weight of Block 2 = " << block_weights[2]
            << " (<= " << individual_block_weights[2] << ")" << std::endl;
  std::cout << "Weight of Block 3 = " << block_weights[3]
            << " (<= " << individual_block_weights[3] << ")" << std::endl;
